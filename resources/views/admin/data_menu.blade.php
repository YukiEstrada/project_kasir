...
<p style="margin-top:20px;margin-bottom:20px">Search Menu</p>
      <form action="" method="GET">
        <input type="text" name="search" placeholder="Enter Menu Name" value="{{ old('search') }}">
        <button type="submit" class="btn btn-primary btn-rounded"value="SEARCH"> <i class="fas fa-search"></i></button>
      </form>
